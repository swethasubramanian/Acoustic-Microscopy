...
public:
    ...
    void retranslateUi(QMainWindow *bsc)
    {
        ...
        label_9->setText(QApplication::translate("bsc", "Skittles (BSC Measurement Tool)", 0));
